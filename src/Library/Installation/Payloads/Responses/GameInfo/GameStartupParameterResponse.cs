using GameHost.Games.Lib.Installation.Payloads.Responses.GameInfo.StartupParameters;
using GameHost.Games.Lib.Installation.Providers;
using System.Text.Json.Serialization;

namespace GameHost.Games.Lib.Installation.Payloads.Responses.GameInfo;
